...
import com.epam.CPP.service.StringRequestService;
...
public class MainController {
    @Autowired
    StringRequestService stringRequestService;
    ...
    public String countCharacter(Model model, @ModelAttribute("Text") String text, @ModelAttribute("Letter") String letter) {
        ...
        statistic.update();
        stringRequestService.createRequest(text, letter);
        int occurrence = stringRequestService.completeTask(text, letter);
